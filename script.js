...
async function findOrCreateRoom() {
  ...
  // Tạo phòng mới
  const newRoomId = "room_" + Math.floor(Math.random() * 1000000);
...
async function startGame() {
  ...
  const nguoiChoiRef = db.ref("Phong/" + roomId + "/NguoiChoi/" + idNguoiChoi);
  const roomNguoiChoiRef = db.ref("Phong/" + roomId + "/NguoiChoi");
